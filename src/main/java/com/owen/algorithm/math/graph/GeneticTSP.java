...
public class GeneticTSP {
    ...
    public static GeneticTSP getInstance() {
        return GeneticTSPHolder.instance;
    }

    private static class GeneticTSPHolder {
        private static GeneticTSP instance = new GeneticTSP();
    }
